...
aboard | adv. 在飞机上；在船上；在火车上 prep. 在…上
...
advanced | adj. 先进的；高级的；晚期的；年老的 v. 前进；增加；上涨
advantage | n. 优势
adversity | n. 逆境
advert | v. 提及
...
ahead | adj. 向前；在前的；领先 adv. 向前地；领先地；在……前面；预先；在将来，为未来
aid | n. 帮助；助手
...
am | abbr. 调频，调谐，调幅 v. （用于第一人称单数现在时）
...
annoy | v. 骚扰；惹恼；打搅 n. 烦恼（=annoyance）
annual | adj. 一年一度的
annually | adv. 一年一度地
...
apparently | adv. 看来
appeal | v. 呼吁，恳求；上诉；诉诸，求助；有吸引力，迎合爱好；诉诸裁判 n. 呼吁，请求；吸引力，感染力；上诉；诉诸裁判
...
art | n. 艺术；美术；艺术品 adj. 艺术的；艺术品的
article | n. 文章；物品；条款；冠词 v. 订约将…收为学徒或见习生；使…受协议条款的约束
artificial | adj. 人造的；仿造的；虚伪的；非原产地的；武断的
artist | n. 艺术家；美术家（画家）；大师
artwork | n. 艺术品
...
assistant | n. 助手，助教 adj. 辅助的；有帮助的
...
availability | n. 可用
avalanche | n. 雪崩
avenue | n. 大街；林荫大道；途径，方法
average | n. 平均；平均数；海损 adj. 平均的；普通的 v. 算出…的平均数；将…平均分配；使…平衡
avoid | v. 避免；避开，躲避；消除
await | v. 等候，等待；期待
...
beam | n. 横梁；光线；电波；船宽；秤杆 v. 发送；以梁支撑；用…照射；流露
...
betray | v. 背叛；食言；违背
better | n. 长辈；较好者；打赌的人（=bettor） adv. 更好的；更多的；较大程度地 adj. 较好的 v. 改善；胜过
...
bill | n. 法案；广告；账单；票据；钞票；清单 v. 宣布；开账单；用海报宣传
...
biscuit | n. 小点心，饼干
bit | n. 比特；少量；马嚼子；辅币；老一套；一点，一块 v. 控制 adj. 很小的；微不足道的 adv. 有点儿；相当
bite | v. 咬；刺痛 n. 咬；一口；咬伤；刺痛 abbr. 机内测试设备（Built-In_Test_Equipment）
bitter | adj. 激烈不愉快的
bituminous | adj. 沥青的
bizarre | adj. 怪诞的
...
blunder | v. 摸索 n. 疏忽
blue | n. 蓝色；（美国海、陆、空三军穿的）蓝色制服；蓝颜料；布鲁斯，一种伤感的美国黑人民歌 adj. 蓝色的；沮丧的，忧郁的；下流的 v. 把…染成蓝色；使成蓝色；给…用上蓝剂；用上蓝剂于
...
cabbage | n. 卷心菜，甘蓝菜，洋白菜；（俚）脑袋；（非正式、侮辱）植物人（常用于英式英语）；（俚）钱，尤指纸币
...
calendar | n. 日历；历法；日程表 v. 将…列入表中；将…排入日程表
call | v. 呼叫；拜访；叫牌 n. 电话；呼叫；要求；访问
calm | adj. 静的，平静的；沉着的 v. 使平静；使镇定 n. 风平浪静
calorimeter | n. 热量计
camel | n. 骆驼；打捞浮筒；工作作风官僚 adj. 驼色的；暗棕色的 v. 工作刻板平庸
camera | n. 照相机；摄影机
camp | v. 露营；扎营 n. 露营
campaign | n. 运动
campus | n. （大学）校园；大学，大学生活；校园内的草地（-es）
can | v. 将…装入密封罐中保存 aux. 能；能够；可以；可能 n. 罐头；（金属或塑料）容器；（马口铁或其他金属）食品罐头
canal | n. 运河 v. 开凿运河
cancel | v. 取消；删去 n. 取消，撤销
cancer | n. 癌症；恶性肿瘤
candidate | n. 候选人，候补者；应试者
candle | n. 蜡烛；烛光；烛形物 v. 对着光检查
candy | v. 用糖煮；使结晶为砂糖；美化 n. 糖果（=sweets）；冰糖（=sugar_candy，rock_candy）；毒品 adj. 新潮的（服饰）；甜言蜜语的
canteen | n. 食堂，小卖部；水壶
cap | n. 盖；帽子 v. 脱帽致意
capability | n. 能力
capable | adj. 有能力的
...
carrier | n. 载体；运送者；带菌者；货架
carrot | n. 胡萝卜
carry | v. 拿，扛；携带；支持；搬运 n. 运载；进位；射程
cartoon | n. 卡通片，动画片；连环漫画 v. 为…画漫画
case | n. 情况；实例；箱 v. 包围；把…装于容器中
cash | n. 现款，现金 v. 将…兑现；支付现款
cashier | n. 出纳员；司库；收银员 v. 解雇；抛弃
cassette | n. 盒式磁带；暗盒；珠宝箱；片匣
cast | v. 投，抛；计算；浇铸；投射（光、影、视线等） n. 投掷，抛；铸件，铸型；演员阵容；脱落物
...
character | n. 性格，品质；特性；角色；字符 v. 印，刻；使具有特征
...
charity | n. 慈善机构
charm | n. 魅力 v. 吸引
chart | n. 图表；海图；图纸；排行榜 v. 绘制…的图表；在海图上标出；详细计划；记录；记述；跟踪
...
cheese | n. 奶酪；干酪；要人 v. 停止 adj. 叛变的；胆小的
...
chin | n. 下巴
china | n. 瓷器 adj. 瓷制的
chip | v. 削，凿；削成碎片 n. 芯片；筹码；碎片；(食物的)小片；薄片
chocolate | n. 巧克力，巧克力糖；巧克力色 adj. 巧克力色的；巧克力口味的
choke | v. 呛；使窒息；阻塞；抑制；扑灭 n. 窒息；噎；阻气门
choose | v. 选择，决定
...
cite | v. 引用；传讯；想起；表彰
citizen | n. 公民；市民；老百姓
citizenship | n. 公民身份，公民资格；国籍；公民权
...
clarify | v. 澄清；阐明
clarity | n. 清晰，清楚；清澈，明净
clash | n. 冲突，不协调；碰撞声，铿锵声 v. 冲突，抵触；砰地相碰撞，发出铿锵声
clasp | n. 搭扣
class | n. 阶级；班级；种类；班；等级 v. 分类；把…分等级；把…编入某一班级 adj. 极好的；很好的，优秀的，出色的
...
component | adj. 组成的，构成的 n. 成分；组件；元件
...
conductor | n. 乐队指挥
conference | n. 会议；讨论；协商；联盟 v. 举行或参加（系列）会议
...
core | n. 核心；要点；果心；磁心 v. 挖的核
corn | n. （美）玉米；（英）谷物；鸡眼 v. 腌；使成颗粒
corner | n. 角落，拐角处；地区，偏僻处；困境，窘境 v. 囤积；相交成角
corporate | adj. 公司的 n. 公司
...
corrupt | adj. 腐败的；不道德的 v. 使腐化，使堕落
...
counter | n. 柜台；对立面；计数器；筹码 v. 反击，还击；反向移动，对着干；反驳，回答 adj. 相反的 adv. 反方向地；背道而驰地
countersign | v. 副署，会签 n. 副署，会签；应答
...
cramp | n. 痉挛 v. 束缚 adj. 狭窄的
cranky | adj. 脾气坏的
crash | n. 撞碎；坠毁；破产；轰隆声；睡觉 v. 摔碎；坠落；发出隆隆声；破产
...
credit | n. 信用，信誉；贷款；学分；信任；声望 v. 相信，信任；把…归给，归功于；赞颂
...
culture | n. 文化，文明；修养；栽培 v. 培养（=cultivate）
cup | n. 杯子；奖杯；酒杯 v. 使成杯状；为…拔火罐
cupboard | n. 碗柜；食橱
cure | v. 治愈；硫化；加工处理 n. 治愈；疗法
...
dairy | n. 奶制品；乳牛；制酪场；乳品店；乳品业 adj. 乳品的；牛奶的；牛奶制的；产乳的
dam | v. 控制；筑坝 n. 水坝；障碍
...
dimension | n. 方面；维；尺寸；次元；容积 vt标出尺寸 adj. 规格的
dimmer | n. 调光器
dine | v. 进餐，用餐
...
divide | v. 划分；除；分开；使产生分歧 n. 分水岭，分水线
division | n. 除法；部门；分配；分割；师（军队）；赛区
divorce | n. 离婚 v. 离婚
dizzy | adj. 晕眩的；使人头晕的；昏乱的；心不在焉的；愚蠢的 v. 使头晕眼花；使混乱；使茫然
do | n. 要求；规定 v. 做；干；学习；研究；进行；完成；解答；整理；算出；引起；行过 aux. 助动词；（代替动词）；（用于加强语气）
doctor | v. 修理；篡改，伪造；为…治病；授以博士学位 n. 医生；博士
document | n. 文件，公文；文档；证件 v. 用文件证明
...
down payment | n. 首付
down | adv. 向下，下去；在下面 adj. 向下的 n. 软毛，绒毛；开阔的高地 prep. 沿着，往下 v. 打倒，击败
download | n. 下载 v. 下载
downstairs | adv. 在楼下 adj. 楼下的 n. 楼下
downtown | adv. 往闹市区；在市区 adj. 市中心的 n. 市中心区；三分线以外
downturn | n. 低迷
dozen | n. 十二个，一打 adj. 一打的
draft | n. 汇票；草稿；选派；气流 v. 起草；制定；征募 adj. 初步画出或的；正在起草中的，草拟的；以草稿形式的；草图的
...
drive | v. 开车；猛击；飞跑 n. 驱动器；驾车；内驱力，推进力；快车道
...
earth | n. 地球；地表，陆地；土地，土壤；尘事，俗事；兽穴 v. 把（电线）接地；盖（土）；追赶入洞穴
earthquake | n. 地震；大动荡
...
either | adj. 两者之中任一的；两者之中每一的 prep. 任何一个 conj. 也；根本 pron. 任一，两方，随便哪一个；两者中的一个或另一个
eke | v. 节约使用
...
essential | adj. 基本的；必要的；本质的；精华的（-ly） n. 本质；要素；要点；必需品
...
even | adj. 偶数的；平坦的；相等的 adv. 甚至；即使；还；实际上 v. 使平坦；使相等
evening | n. 晚上；傍晚；（联欢性的）晚会；后期 adj. 在晚上的；为晚上的；晚上用的 int. 晚上好（=good_evening）
event | n. 事件，大事；项目；结果
eventual | adj. 最终的
...
extent | n. 程度；范围，长度
exterior | adj. 外部的
external | adj. 外部的；表面的；外用的；外国的；外面的 n. 外部；外观；外面
extinct | adj. 灭绝的；消亡的
extinction | n. 消亡
...
facility | n. 设施，设备
fact | n. 事实；实际；真相
factor | n. 因素；要素；因数；代理人 v. 做代理商
factory | n. 工厂；制造厂；代理店
faculty | n. 科，系；能力；全体教员
fade | v. 褪色；凋谢；逐渐消失 adj. 平淡的；乏味的 n. 淡出；淡入
fail | v. 失败，不及格；破产；缺乏；衰退 n. 不及格
failure | n. 失败；故障；失败者；破产
faint | adj. 模糊的；头晕的；虚弱的；衰弱的 v. 昏倒；变得微弱；变得没气力 n. 昏厥，昏倒
fair | adj. 公平的；美丽的，白皙的；晴朗的 adv. 公平地；直接地；清楚地 v. 转晴 n. 展览会；市集；美人
fairly | adv. 相当地
...
farewell | n. 告别，辞别；再见；再会 int. 别了！；再会！ adj. 告别的
...
fatty | adj. 脂肪的 n. 胖子
fault | n. 故障；断层；错误；缺点；毛病；（网球等）发球失误 v. 弄错；产生断层
faulty | adj. 有故障的
...
female | adj. 女性的；雌性的；柔弱的，柔和的 n. 女人；雌性动物
fence | n. 栅栏；围墙；剑术 v. 防护；用篱笆围住；练习剑术
fermented | adj. 发酵的
ferry | n. 渡船；摆渡；渡口 v. 渡过；用渡船运送；空运
...
filter | v. 滤过；渗入；慢慢传开 n. 滤波器；过滤器；筛选；滤光器
...
fisherman | n. 渔夫；渔人
fist | n. 拳，拳头；〈口〉笔迹；掌握；指标参见号 v. 紧握；握成拳；用拳打
...
flat | adj. 平的；单调的；不景气的；干脆的；平坦的；扁平的；浅的 adv. 平直地；断然地；水平地；直接地，完全地 n. 平地；公寓；平面 v. 使变平；使（音调）下降，尤指降半音 v. 逐渐变平；以降调唱（或奏）
flee | v. 逃走；消失，消散
...
fragrance | n. 芳香
frame | n. 框架；结构；画面 v. 设计；建造；陷害；使…适合 adj. 有木架的；有构架的
framework | n. 框架，骨架；结构，构架
franc | n. 法郎
frankness | n. 率直；坦白
free | adj. 免费的；自由的，不受约束的；游离的 v. 使自由，解放；释放 adv. 自由地；免费
freedom | n. 自由，自主；直率
freeway | n. 高速公路
...
function | n. 功能；函数；职责；盛大的集会 v. 运行；活动；行使职责
...
grief | n. 悲痛；忧伤；不幸
grind | v. 磨碎；挤压 n. 苦差事；摩擦（声）
grip | n. 紧握；柄；支配；握拍方式；拍柄绷带 v. 紧握；夹紧
grocer | n. 杂货店；食品商
groceries | n. 杂货；食品；生活用品
grope | v. 摸索 n. 摸
gross domestic product | abbr. 总的_国内的_生产值
...
```
HIV | abbr. 艾滋病病毒（human_immunodeficiency_virus）
...
helicopter | n. 直升飞机 v. 乘直升飞机 v. 由直升机运送
hell | n. 地狱；究竟；训斥；黑暗势力 v. 过放荡生活；飞驰 int. 该死；见鬼
...
hesitate | v. 踌躇，犹豫；不愿
hesitation | n. 犹豫
hey | int. 喂！（引起注意等）；你好！（表示问候） n. 干草（=hay）
...
hospital | n. 医院
hospitalize | v. 住院
host | n. 主机；主人；主持人；许多 v. 主持；当主人招待
...
identify | v. 确定；鉴定；识别，辨认出；使参与；把…看成一样；确定；认同；一致
...
illegal | adj. 非法的；违法的；违反规则的 n. 非法移民，非法劳工
illness | n. 病；疾病
illuminate | v. 照射
...
impression | n. 印象；效果，影响；压痕，印记；感想；曝光（衡量广告被显示的次数。打开一个带有该广告的网页，则该广告的impression次数增加一次）
impressive | adj. 印象深刻的
improve | v. 改善，增进；提高…的价值
improvement | n. 改进，改善；提高
improvise | v. 即兴表演
impulse | n. 冲动；脉冲；刺激；神经冲动；推动力 v. 推动
...
infinite | adj. 无限的，无穷的；无数的；极大的 n. 无限；无穷大；无限的东西（如空间，时间）
...
innovative | adj. 革新的
inoculate | v. 接种；嫁接；灌输
input | n. 投入；输入电路 v. 输入；将…输入电脑
inquire | v. 询问；查究；问明
inquiry | n. 探究；调查；质询
insanely | adv. 疯狂地
insect | n. 昆虫；卑鄙的人
insecurity | n. 不安全，无把握
insert | v. 插入；嵌入 n. 插入物；管芯；镶块；刀片
...
interject | v. 突然插入；插嘴
intermediate | v. 起媒介作用 adj. 中间的，中级的 n. 中间物；媒介
...
jacket | n. 羽绒滑雪衫；西装短外套；短上衣，夹克；土豆皮；书籍的护封；文件套，公文夹 v. 给…穿夹克；给…装护套；给…包上护封
jail | n. 监狱 v. 监禁
...
jockey | n. 赛马骑师
jog | v. 慢跑；轻推；蹒跚行进；使颠簸 n. 慢跑；轻推，轻撞(jogging)
...
juggle | v. 杂耍；力图平衡；篡改 n. 杂耍；平衡；虚报
juice | n. （水果）汁，液；果汁
...
landmass | n. 大陆
landscape | n. 风景；风景画；景色；山水画；乡村风景画；地形；横向打印格式 v. 对…做景观/园林美化
lane | n. 小巷；航线；车道；罚球区
...
layer | n. 层，层次；膜；压条；放置者，计划者 v. 把…分层堆放；借助压条法；生根繁殖；将（头发）剪成不同层次
layout | n. 布局
...
living-room
lizard | n. 蜥蜴
load | n. 负载，负荷；工作量；装载量 v. 加载；装载；装货
...
long | n. 长时间；长音节；（服装的）长尺寸；长裤 adj. 长的；过长的；做多头的；长时间的；冗长的，长音 v. 渴望；热望 adv. 长期地；始终
longevity | n. 寿命；持久
...
major | adj. 主要的；重要的；主修的；较多的 n. 成年人；主修科目；陆军少校 v. 主修
majority | n. 多数；成年
make | v. 使得；进行；布置，准备，整理；制造；认为；获得；形成；安排；引起；构成 n. 制造；构造；性情
makeshift | n. 权宜之计；凑合；临时措施；将就 adj. 临时的；权宜的；凑合的
...
message | n. 消息；差使；启示；预言；广告词 v. 报信，报告；报文
messager | n. 使者；送信者
messenger | n. 报信者，送信者；先驱
messy | adj. 脏的；棘手的
metabolic | adj. 新陈代谢的
metal | n. 金属；合金 v. 以金属覆盖 adj. 金属制的
meter | n. 米；仪表；公尺；韵律 v. 用仪表测量
method | n. 方法；条理；类函数 adj. 使用体验派表演方法的
microcomputer | n. 微电脑；微型计算机
...
minibus | n. 面包车（=microbus）；小型公共汽车；中客车 v. 乘中客车
...
minute | n. 分，分钟；片刻，一会儿；备忘录，笔记；会议记录 v. 将…记录下来 adj. 微小的，详细的
...
mystery | n. 秘密，谜；神秘，神秘的事物；推理小说，推理剧；常作_mysteries_秘技，秘诀
myth | n. 神话；虚构的人，虚构的事
mythical | adj. 神话的
```
...
negative | adj. 负的；消极的；否定的；阴性的 n. 否定；负数；底片 v. 否定；拒绝
...
niche | n. 壁龛；合适的职业；有利可图的市场(形势) v. 放入壁龛 adj. 针对特定小群体的
nick | n. 裂口；绰号 v. 刻痕于，使有缺口
nicotine | n. 尼古丁
niece | n. 外甥女，侄女
...
orchard | n. 果园；果树林
orchestra | n. 管弦乐队
order | n. 命令；顺序；规则；定单 v. 命令；整理；定购
...
outcome | n. 结果，结局；成果
outdoor | adj. 户外的；露天的；野外的（=out-of-door）
outdoors | adv. 在户外 n. 户外 adj. 户外的（=outdoor）
...
outward | adj. 向外的；外面的；公开的；外服的；肉体的 adv. 向外（=outwards）；在外；显而易见地 n. 外表；外面；物质世界
...
package | n. 包，包裹；套装软件，程序包 adj. 一揽子的 v. 打包；将…包装
...
party | n. 政党，党派；聚会，派对；当事人 v. 参加社交聚会
...
paste | v. 张贴，裱糊；用浆糊粘 n. 面团，膏；糊状物，浆糊
...
perish | v. 使麻木；毁坏
permanent | adj. 永久的，永恒的；不变的 n. 烫发（=permanent_wave）
permanently | adv. 永久地
permission | n. 允许，许可
...
physical | adj. 物理的；身体的；物质的；根据自然规律的，符合自然法则的 n. 体格检查
physician | n. 医师；内科医师
...
pine | v. 渴望，痛苦；憔悴 n. 松树；凤梨，菠萝 adj. 松木的；似松的
pineapple | n. 菠萝；凤梨 adj. 凤梨科的
pink | n. 粉红色；化身，典范；石竹花；头面人物 v. 扎，刺，戳；使…变粉红色；使…面红耳赤 adj. 粉红的；比较激进的；石竹科的；脸色发红的
pinpoint | v. 精准确定 adj. 准确的 n. 光点
...
point | n. 要点；得分；标点；尖端 v. 指向；弄尖；加标点于
pointless | adj. 毫无意义的
poison | v. 污染；使中毒，放毒于；败坏；阻碍 n. 毒药，毒物；酒；有毒害的事物；抑制剂 adj. 有毒的
...
polio | n. 小儿麻痹症（=poliomyelitis）；脊髓灰质炎
polish | v. 擦亮 n. 抛光
...
pop | abbr. 卖点广告（Point_of_Purchase）
...
positive | adj. 积极的；正的，阳性的；确定的，肯定的；实际的，真实的；绝对的 n. 正数；正片
...
powder | n. 粉；粉末；火药；尘土 v. 使成粉末；撒粉；搽粉于
power | n. 力量，能力；电力，功率；政权，势力；幂 v. 激励；供以动力；使…有力量 adj. 借影响有权势人物以操纵权力的
...
press | v. 压；按；逼迫；紧抱 n. 压；按；新闻；出版社；印刷机
pressure | n. 压力；压迫，压强 v. 迫使；密封；使……增压
...
promotion | n. 提拔；提升
prompt | adj. 敏捷的 v. 提示；促进；激起；提白 n. 提示；付款期限；DOS命令：改变DOS系统提示符的风格 adv. 准时地
promptly | adv. 迅速地
prone | adj. 俯卧的；有倾向的，易发生的
...
proportional | adj. 比例的，成比例的；相称的，均衡的 n. 比例项
proposal | n. 提议，建议；求婚
...
provided | conj. 假如
province | n. 省；领域；职权
provision | n. 规定；条款；准备；供应品 v. 供给…食物及必需品
...
quit | v. 离开；放弃；停止；使…解除 n. 离开；退出 adj. 摆脱了…的；已经了结的
quite | adv. 很；相当；完全
quiz | n. 考查；恶作剧；课堂测验（-zzes） v. 挖苦；张望；对…进行测验
...
rationally | adv. 理性地
rationing | n. 定量配给
raw | adj. 生的；未加工的；阴冷的；刺痛的；擦掉皮的；无经验的；不成熟的 n. 擦伤处 v. 擦伤
ray | n. 光束 v. 放射
...
relative | adj. 相对的；有关系的；成比例的 n. 亲戚；相关物；关系词；亲缘植物
...
resume | n. 摘要；履历，简历 v. 重新开始，继续；恢复，重新占用
...
routine | n. 程序；日常工作；例行公事 adj. 日常的；例行的(-ly)
...
secure | adj. 安全的；无虑的；有把握的；稳当的 v. 保护；弄到；招致；缚住(-ly)
security | n. 保障
see | v. 看见；理解；领会
...
senior | adj. 高级的；年长的；地位较高的 n. 上司；较年长者；毕业班学生
...
sensitivity | n. 感知；灵敏度
sentence | n. 句子，命题；宣判，判决 v. 判决，宣判
separate | v. 使分离；使分开；使分居 adj. 单独的；分开的；不同的；各自的； n. 分开；抽印本
sequence | n. 序列；顺序；续发事件 v. 按顺序排好
...
set | n. 集合；一套；布景；装置 v. 树立；点燃；点缀； adj. 固定的；规定的；固执的
setback | n. 挫折
settle | v. 安放；解决；定居；沉淀；下陷 n. 有背长椅
settled | adj. 定居的
settlement | n. 沉降；定居；开拓
settler | n. 侨民
seven | num. 七个，七 n. 七个，七 adj. 七的；七个的
seventeen | n. 十七，十七个 adj. 十七岁的；十七的，十七个的 num. 十七
seventh of nine | abbr. 九个中的第七个
...
shall | aux. 应；会；将；必须
shallow | adj. 浅的；肤浅的 n. 浅滩 v. 使变浅
shame | n. 羞耻，羞愧；憾事，带来耻辱的人（-ful） v. 使丢脸，使羞愧
...
skilled | adj. 熟练的
skillful | adj. 熟练的
skim | v. 撇去 n. 表层物 adj. 脱脂的
skimp | v. 克扣；节省 adj. 不足的
skin | n. 皮肤；外皮 v. 剥皮
...
sleeve | n. 套筒，套管；袖子，袖套 v. 给……装袖子；给……装套筒
...
slip | v. 滑动；滑倒；犯错；失足；减退 n. 滑，滑倒；片，纸片；错误；下跌；事故 adj. 滑动的；有活结的；活络的
...
sneeze | v. 打喷嚏 n. 喷嚏
sniffle | v. 抽鼻涕；抽噎（=snuffle） n. 鼻塞声；不断的吸鼻子（=snuffle）
snow | n. 雪，积雪；下雪 v. 降雪
snowball | n. 雪球 v. 投雪球
snowman | n. 雪人
snowy | adj. 下雪的
...
soldier | n. 军人；兵蚁；懒汉；一片烤面包 v. 当兵；磨洋工；坚持干；假称害病
...
soot | n. 烟灰
sophisticate | v. 使老于世故
sophisticated | adj. 复杂的；精致的；久经世故的；富有经验的(un-)
sophistication | n. 精明
sore | adj. 疼痛的；剧烈的；恼火的；厉害的 n. 痛处；恨事，伤心事
...
sound | v. 听（诊）；测量，测…深；使发声；试探；宣告 n. 声音，语音；噪音；海峡；吵闹；听力范围；探条 adj. 健全的，健康的；合理的；可靠的；有效彻底的 adv. 彻底地，充分地
...
stifle | v. 扼杀；使窒息；藏匿 n. （马等的）后膝关节；（马等的）后膝关节病
...
stone | n. 石头；结石；宝石 adj. 石的，石制的 v. 向扔石块；用石头铺
...
subdivide | v. 细分
subject | n. 主题；科目；主语；国民 adj. 服从的；易患…的；受制于…的 v. 使…隶属；使屈从于…
submerges | v. 淹没；掩盖
submit | v. 使服从；主张；呈递
...
summer | n. 夏天 v. 避暑
sun | n. 太阳 v. 使晒
sunburn | n. 晒黑；晒斑 v. 晒伤皮肤；晒红皮肤；晒黑皮肤
sunglasses | n. 太阳镜
sunlight | n. 日光
...
telegraph | n. 电报机，电报 v. 电汇；流露出；打电报给…
...
text | n. 文本；课文；主题 v. 发短信
textbook | n. 教科书，课本
texture | n. 质地；神韵；和谐
than | conj. 比（用于形容词、副词的比较级之后）；除…外（用于other等之后）；与其…（用于rather等之后）；一…就（用于
...
till | n. 冰碛；放钱的抽屉；备用现金 prep. 直到 conj. 直到为止 v. 耕种；犁
...
tolerate | v. 忍受；默许；宽恕
tomato | n. 番茄，西红柿
tomorrow | n. 明天；未来 adv. 明天；未来地（=to-morrow）
ton | n. 吨；很多，大量
...
traffic | n. 交通；运输；贸易；通信量 v. 用…作交换；在…通行
trafficking | n. 非法交易
tragedy | n. 悲剧；灾难；惨案
...
transportation | n. 运输
trap | v. 诱捕；使…受限制；使…陷入困境 n. 陷阱；圈套；存水湾
trash can | n. 垃圾桶
travel | v. 旅行 n. 旅行
traveler | n. 旅行者
...
tribe | n. 部落；族；宗族；一伙
tribute | n. 礼物；贡物；颂词；（死者的）致敬，悼念，吊唁礼物
...
uniformity | n. 统一
union | n. 联盟，协会；工会；联合
unique | adj. 独特的，稀罕的；唯一的，独一无二的 n. 独一无二的人或物
...
used | adj. 习惯的；二手的，使用过的 v. 用（use的过去式）；（used_to）过去常做
...
variable | adj. 变量的；可变的；易变的，多变的；变异的，畸变的 n. 变量；可变物，可变因素
variation | n. 变化；变异，变种
variety | n. 多样；种类；杂耍；变化，多样化
various | adj. 各种各样的；多方面的
vary | v. 变化；变异；违反
vast | adj. 广阔的；巨大的；大量的；巨额的（-ly） n. 浩瀚；广阔无垠的空间
...
vice | n. 恶习；缺点；老虎钳；卖淫 prep. 代替 v. 钳住 adj. 副的；代替的
vicious | adj. 凶险的
...
wallet | n. 钱包，皮夹
wand | n. 魔杖；棒；权杖；嫩枝；识别笔（=wand_reader） v. 用扫描笔在…上扫描条形码
...
word | n. 单词；话语；消息；诺言；命令 v. 用言辞表达
wordlessly | adv. 沉默地
work | n. 工作；功；产品；操作；职业；行为；事业；工厂；著作；文学、音乐或艺术作品 v. 使工作；操作；经营；使缓慢前进
...
writer | n. 作家；作者
writing | n. 书写；作品；著作；笔迹 v. 书写（write的ing形式）
...
zebra | n. 斑马 adj. 有斑纹的
zero | n. 零点，零度 num. 零
zigzag | n. 之字形，锯齿形线条 v. 之字移动 adj. 之字形的 adv. 之字形地
zipper | n. 拉链 v. 拉上拉链
...
a multitude of | phr. 众多的；大量的
a series of | phr. 一系列；连续
a lack of | phr. 缺乏
a treasury of | phr. 富有
a walk of life | phr. 行业；职业；地位；阶层
accept/take ... at face value | phr. 相信表面；信以为真
account for  | phr. （数量上、比例上）占；解释；找到···位置
all of a sudden | phr. 突然；猛地
apply for | phr. （通常以书面形式）申请，请求
apply to | phr. 使用；应用
as luck would have it | phr. 碰巧巧；偶然；幸而
as well as | phr. 除···之外
assure ... of ... | phr. 使放心；向···保证
at a time | phr. 每次；逐一；依次
at one point | phr. 在某个时刻
at one's disposal | phr. 任某人处理；供某人任意使用
at/in/to the forefront of ... | phr. 处在最前列；进入重要地位
bargain for | phr. 预料到；料想到
bask in | phr. 晒太阳；取暖
be accustomed to ... | phr. 习惯于
be attributed to | phr. 把···归因于；认为···是由于
be characteristic of | phr. 典型的；独特的；特有的
be in control of | phr. 掌管；管理；控制
be linked to | phr. 与···有联系
be lost in one's thought | phr. 陷入沉思
be prepared for | phr. 准备好；有所准备
be prone to | phr. 易于
be reliant upon | phr. 依赖；依靠
be up to | phr. 取决于
be/feel privileged to do | phr. 荣幸地做某事
because of | phr. 因为
believe in | phr. 认为某事好（对、可接受）
biological mother | phr. 生母
board of directors | phr. 董事会
break down | phr. 失败
brain drain | phr. 人才流失
bring ... to light | phr. 揭露；披露；揭发
bring ... to the table | phr. 带来好处
bring about | phr. 导致；引起
bring in | phr. 赚得；挣
butterflies in the stomach | phr. 心里七上八下
by and large | phr. 大体上；总体上
call forth | phr. 引起；使产生
care about sb | phr. 关心；关怀
care for | phr. 照顾，照料（病、者、幼者等）
carry out | phr. 完成（任务）
close down | phr. 停业
come down with | phr. 患，得，染上（小病）
come up with | phr. 找到（答案等）
conduct oneself | phr. 举止；表现
convert ... into | phr. （使）转变，转换，转化
cutting edge | phr. （处于某事物发展的）尖端，最前沿，领先阶段
deep down | phr. 实际上；在心底
deprive ... of ... | phr. 剥夺；使丧失
drop ... off | phr. （顺路）把···放下
drop out | phr. 退学；辍学
dwell on | phr. 老是想着（尤指最好忘记的事）
eke out a living | phr. 竭力维持生计；勉强度日
end up | phr. 最终成为；最后处于
engage in | phr. （使）从事，参加
evolve out of | phr. 由···演变而来
fact frequently overtakes | phr. 事实往往压倒一切
fall over | phr. 被···绊倒；几乎被···绊倒
fall to pieces | phr. 崩溃；倒塌；解体
feel good | phr. 感到愉快（或有信心等）
fight back | phr. 奋力抵抗；还击
fill out | phr. 膨帐；扩张；长胖；长肥
fit in | phr. （与···）合得来；造应
from scratch | phr. 从头开始；从零开始
get ... up | phr. 安排；组织
get lost | phr. 不知所措；一筹莫展
get over | phr. 解決；克服；控制
give up ... to ... | phr. 把···交给（或让与）···
go off | phr. 突然发出巨响
go through | phr. 经历；遭受
grow tired of | phr. 厌倦
God/Heaven/Lord forbid (that...) | phr. 但愿这事不发生
have an impact on/upon | phr. 对···产生巨大影响
happen to | phr. 碰巧发生
head off | phr. 阻止
head over heels in love | phr. 深深地爱着某人；迷恋
in desperation | phr. 在绝望中；走投无路
in essence | phr. 本质上
in memory of | phr. 作为对···的纪念
in place | phr. 在工作；准备就绪
in plain sight | phr. 显而易见
in public | phr. 公开地；在别人（尤指生人）面前
in this manner | phr. 用这种方式
in this respect | phr. 在这方面
inch by inch | phr. 缓慢而蓮慎地；一步一步
join in | phr. 参加，加入（活动）
jump out of one's skin | phr. 欢喜雀跃；兴高采烈
keep tabs on | phr. 监视；密切注视
keep track of | phr. 了解···的情況（或动态）
keep up with | phr. （与···）齐步前进；并驾齐驱；跟上
lead to | phr. 导致，造成（后果）
lie in | phr. 存在；在于
line up | phr. 排成一行；站队；排队（等候）
look back on | phr. 回首（往事）；回忆；回顾
look forward to | phr. （高兴地）盼望，期待
lump sum | phr. 一次结清
major in | phr. 主修
make a difference | phr. 有作用；产生影响
make a hit | phr. 给（某人）留下很好的第一印象；使（某人）一见钟情
make it | phr. 获得成功
make one's way | phr. 去；前往；到···地方去
make up | phr. 弥补；虚构
man of letters | phr. 文人
meet one's expectations | phr. 符合某人的期望
moan about | phr. 抱怨
on a daily basis | phr. 每日地
on one's feet | phr. （困境后）恢复，完全复原；(病后)痊愈
open up | phr. （使某事物）成为可能，可得到，可达到
outght to be | phr. 应该是
over and over again | phr. 多次；反复地；一再
pace oneself | phr. 调整自己的工作（或活动）节奏
pay attention to | phr. 注意
pay off ... | phr. 付清；偿清
perish the thought | phr. 甭想了；但愿不会如此
pick up | phr. 让人乘年；搭载
pile up | phr. 堆积；积压
poke fun at | phr. 拿···开心；奚落；嘲笑
put ... down | phr. 使（当众）出丑；使出洋相；让某人现眼
put forth | phr. 提出；产生
put up | phr. 举起；提名
reforestation programs | phr. 植树造林计划
respond to | phr. 作出反馈；响应
result in | phr. 导致
rub ... out | phr. 用橡皮擦掉（字迹等）
run out of | phr. 用完；耗尽
save on | phr. 节省；节约
seek out | phr. 寻求
set ... apart from | phr. 区别；使与众不同
set out to | phr. 着手
show off | phr. 炫耀；卖弄
sink in | phr. 被完全理解；被充分意识到
slip away | phr. 消失；消亡；死去
stand ... in good stead | phr. （需要时）对某人有用，对某人有利
stand by | phr. 支持；帮助；忠于
start over | phr. 重新开始
stay up | phr. 熬夜
stick by | phr. 坚持忠于；不离不奔（某人）
stress the importance of | phr. 强调···的重要性
strike up | phr. （和某人）建立友谊，开始来往，交谈起来
struggle with | phr. 斗争；抗争
take .. into account | phr. 考虑到；顾及
take a chance | phr. 冒险
take part | phr. 参加
take one's own life | phr. 自杀
take up | phr. 占去
take wings | phr. 飞走
tend to | phr. 照料；照管；护理
through thick and thin | phr. 不畏艰难险阻
turn against | phr. 背叛
turn out | phr. 原来是；证明是；结果是
two peas in one odd pod | phr. 惺惺相惜
more than two thirds of a meter down | phr. 超过三分之二米深
unemployment lines | phr. 失业队伍
walk out on | phr. 遗弃，抛弃，离开（某人）
warn ... of ... | phr. 警告某人某事
wear out | phr. 使疲乏；使筋疲力尽；使厌烦
with a grain of salt | phr. 有保留地；持怀疑态度地
with ease | phr. 轻而易举地
with the aid of | phr. 在···的辅助下
within one's means | phr. 量入为出
